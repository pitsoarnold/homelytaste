...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Homely Taste is a home bakery crafting cupcakes, rusks and cookies to order. Place your order via WhatsApp at least 2 days in advance." },
      { property: "og:title", content: "Homely Taste — Handcrafted Delights for Every Occasion" },
      { property: "og:description", content: "Handcrafted baked goods made to order. Cupcakes, rusks, cookies and more — order via WhatsApp." },
